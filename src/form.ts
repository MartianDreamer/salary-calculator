...
const insuranceSalaryElement = document.getElementById('insuranceSalary') as HTMLInputElement;
const isFullElement = document.getElementById('insuranceFull') as HTMLInputElement;
const isManualElement = document.getElementById('insuranceManual') as HTMLInputElement;
const dependentsElement = document.getElementById('dependents') as HTMLInputElement;
...
export const handleFormSubmit = (consumeCalculationResult: (result: SalaryCalculationResult) => void) => {
